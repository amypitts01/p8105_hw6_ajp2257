...
```
    ...
    ## ℹ Input `rmse_fit1` is `map2_dbl(fit1, test, ~rmse(model = .x, data = .y))`.
...
![](p8105_hw6_ajp2257_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](p8105_hw6_ajp2257_files/figure-gfm/unnamed-chunk-12-2.png)<!-- -->
...
```
    ...
    ## # A tibble: 1 x 6
    ##   mean_rsquared lower_CI upper_CI mean_log_thing lower_CI_log upper_CI_log
